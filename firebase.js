// Firebase Authentication for Chrome Extensions - Official Google Method
console.log('Firebase auth loading...');

// Initialize Firebase (avoiding inline JavaScript as required by CSP)
...
window.firebaseAuth = {
  signInWithGoogle: async () => {
    try {
      ...
      // Step 2: Create Firebase credential with the Google token
      ...
      // Step 5: Call your API with the Firebase token
